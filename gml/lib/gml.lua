...
local function runGui(gui)
  ...
  while true do
    ...
    elseif e[1]=="drag" and (not screenaddr or e[2] == screenaddr) then
    ...
    elseif e[1]=="drop" and (not screenaddr or e[2] == screenaddr) then
      local tx,ty=e[3],e[4]
      tx=tx-gui.bodyX+1
      ty=ty-gui.bodyY+1
...
local function addTextField(gui,x,y,width,text)
  ...
  tf.charHandler=function(tfclear,char)
    tf:insertText(char)
    dirty=true
  end
